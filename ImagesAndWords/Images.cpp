...
Image *ReadImage(const char* filename)
{
	...
	// calculate image size
	// in img2, the width is 43691 and the height is 3, and 43691 * 3 is 131073, wich in unsigned short i will overflow and become 1,
	// and then it is trying to read a large file data into a small size 1 char buffer -> error.
